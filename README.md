...
Get the sections for a given page. This makes parsing for quotes more manageable. Returns an array of all sections that have headings of specific format, like a letter of the alphabet or a range of letters. Returns the titles that were used in case there is a redirect.
